...
int segment::funct(string slika, string pozadina, bool show)
{
    ...
    // namedWindow("Image");
    // imshow("Image", img);
    //Mat temple = img(Rect(705,513,90,70));
    //imwrite("template_grayscale.jpg", temple);
    //======================================
    ...
    for (auto i = 1; i < num_objects; i++)
    {
        ...
        putText(outputLabels, ss.str(), Point2d(centroids.at<short>(i, 0)-20, centroids.at<short>(i, 1)), FONT_HERSHEY_SIMPLEX, 0.5 ,Scalar(255, 255, 255));
    }
